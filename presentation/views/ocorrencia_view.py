...
class OcorrenciaView:
    ...
    def vw_editar_ocorrencia(self, ocorrencia: 'Ocorrencia'):
        ...
        # Ajustar prestador_id se 'Nenhum' for selecionado
    ...
    def __edit_ocorrencia_layout(self, ocorrencia: 'Ocorrencia'):
        ...
        prestadores = self.usuarios_controller.obter_prestadores_servicos()

        prestadores = ['Nenhum'] + prestadores
        ...
        layout = [
            ...
            [sg.Text("Prestador de serviço"),
             sg.Combo(prestadores, size=(20, 1), default_value=ocorrencia.prestador_id or 'Nenhum', key='prestadores')],
            [sg.Text("Status"),
    ...
    def __show_details_layout(self, ocorrencia: 'Ocorrencia', dirs: list[str]):
        ...
        layout = [[sg.Text("Detalhes da ocorrencia")],
                  ...
                  [sg.Text("Prestador de serviço"), sg.Text(ocorrencia.prestador_id, key="prestadores")],
                  [sg.Text("Imagens: ")],
