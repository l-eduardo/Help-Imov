...
Revision ID: 1203bf273ac1
Revises: e5cec5893e0d
Create Date: 2024-05-25 22:03:48.120278
...
def upgrade() -> None:
    ...
    op.alter_column('CONTRATOS', 'esta_ativo',
    ...
    op.drop_constraint('fk_vistoria_inicial', 'CONTRATOS', type_='foreignkey')
    op.drop_constraint('fk_vistoria_final', 'CONTRATOS', type_='foreignkey')
    ...
    op.alter_column('OCORRENCIAS', 'id_contrato',
               existing_type=mysql.VARCHAR(length=36),
               nullable=True)
    op.drop_constraint('fk_contrato', 'OCORRENCIAS', type_='foreignkey')
    op.create_foreign_key(None, 'OCORRENCIAS', 'CONTRATOS', ['id_contrato'], ['id'])
    ...
    op.alter_column('SOLICITACOES', 'data_criacao',
               ...
               type_=sa.String(length=36),
               existing_nullable=True)
    op.drop_constraint('SOLICITACOES_CONTRATOS_FK', 'SOLICITACOES', type_='foreignkey')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('SOLICITACOES_CONTRATOS_FK', 'SOLICITACOES', 'CONTRATOS', ['contrato_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.alter_column('SOLICITACOES', 'data_criacao',
    ...
    op.create_foreign_key('fk_contrato', 'OCORRENCIAS', 'CONTRATOS', ['id_contrato'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.alter_column('OCORRENCIAS', 'id_contrato',
               existing_type=mysql.VARCHAR(length=36),
               nullable=False)
    op.alter_column('OCORRENCIAS', 'data_criacao',
    ...
    op.create_foreign_key('fk_vistoria_final', 'CONTRATOS', 'VISTORIAS', ['vistoria_final_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key('fk_vistoria_inicial', 'CONTRATOS', 'VISTORIAS', ['vistoria_inicial_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
